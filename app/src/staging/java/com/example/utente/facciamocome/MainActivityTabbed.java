...
public class MainActivityTabbed extends AppCompatActivity implements AsyncTaskCompleteListener<Integer, String>,
...
//              Occorrerebbe fare l'overriding della callback del tasto up. PEr ora uso il trucchetto di memorizzarmi se il tempo è cambiato in ApplicationUtils
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ApplicationUtils.isInternetAvailable(MainActivityTabbed.this)){
            startServerRequest();
        } else {
    ...
    private void startServerRequest(){
        ...
        Context context = MainActivityTabbed.this;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
            ...
            new AlertDialog.Builder(MainActivityTabbed.this)
    ...
    private void showProgressBar(boolean showProgressBar){
        ...
        progressBar.setVisibility((showProgressBar && ApplicationUtils.isInternetAvailable(MainActivityTabbed.this)) ?
